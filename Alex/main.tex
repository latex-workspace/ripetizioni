...
\begin{esercizio}{Scatole di altezza massima}
	Vengono dati in input una serie di scatole, ognuna con tre attributi: \verb|height|, \verb|width| e \verb|depth|. Trovare l'altezza massima che si può ottenere impilando queste scatole
\end{esercizio}
\begin{esercizio}{Intervalli massimi}
	Vengono dati $ n $ intervalli \verb|[start, end]|. Trovare il numero massimo di intervali che non si sovrappongono
\end{esercizio}
\begin{esercizio}{Coin change}
	Dati i tagli di moneta ordinari e un importo totale $ c $, calcolare il numero minimo di monete necessarie per raggiungere $ c $.
\end{esercizio}
\begin{esercizio}{Task scheduling}
