...
\begin{esercizio}{Esercizio avanzato}
	Esercizio Avanzato – Sistema di Gestione Prenotazioni per un Centro Sportivo
	Il Centro Sportivo “ActiveWorld” offre diverse attività (nuoto, palestra, yoga, arrampicata) e vuole un software che gestisca le prenotazioni giornaliere per i vari corsi e spazi.
	...
	\vskip3mm
	File coinvolti
	L’applicazione utilizza tre file:
	Utenti registrati
	(con nome, cognome, data di nascita, telefono, email)
	\vskip3mm
	Attività disponibili
	(es. Nuoto, Palestra, Yoga, Arrampicata)
	...
	3. Visualizzare tutte le prenotazioni
	Raggruppate per attività, ordinate per data.

	4. Cercare le prenotazioni di un utente
	Richiedere email e mostrare tutte le sue prenotazioni.

	5. Aggiungere una nuova prenotazione
	Il programma deve:
	...
	7. Report automatico delle attività quasi piene
	Il programma deve offrire una funzione "Genera Report" che:
	...
	8. Funzionalità extra opzionale (per aggiungere complessità):
	Statistiche settimanali
	Dato un range di date, il programma deve indicare:
